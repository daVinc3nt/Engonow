				...
				{question.choice.map((choice, index) => {
					return (
						<div
							...
							className={`w-full flex flex-row items-center gap-2 border border-transparent 
							rounded-lg duration-100 cursor-pointer p-2 ${isAnswer(String.fromCharCode(65 + index)) ? 
							"bg-red-400 text-white" : "hover:border-red-400 "} `}>
							<div>
